  ...
  return (
    <div className="min-h-screen bg-[--color-background] text-[--color-secondary] flex flex-col items-center py-8 px-4 transition-colors duration-300 relative selection:bg-cyan-500/30">
      ...
      <header className="mb-8 text-center flex flex-col items-center">
        <div className="w-24 h-24 sm:w-28 sm:h-28 mb-6 rounded-full overflow-hidden bg-slate-900/80 border-[3px] border-cyan-500/40 p-1 shadow-[0_0_30px_rgba(34,211,238,0.2)] flex items-center justify-center transition-all hover:border-cyan-400 hover:shadow-[0_0_40px_rgba(34,211,238,0.4)] group backdrop-blur-xl scale-95 sm:scale-100 glow-border">
        ...
        <h1 className="text-5xl sm:text-6xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 mb-2 drop-shadow-[0_0_15px_rgba(34,211,238,0.5)] animate-pulse-slow text-glow">
          Smart Attendance
        </h1>
