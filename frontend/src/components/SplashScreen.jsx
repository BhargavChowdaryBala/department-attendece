    ...
    return (
        <div className={`fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[--color-background] transition-opacity duration-500 ease-in-out ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <div className="relative flex flex-col items-center">
                ...
                <div className="relative w-32 h-32 sm:w-40 sm:h-40 mb-8 rounded-full overflow-hidden bg-slate-900 border-[3px] border-cyan-500/40 p-1 shadow-[0_0_50px_rgba(34,211,238,0.3)] animate-pulse-slow">
                    <img
                        src="/logo.png"
                ...
                <div className="text-center space-y-2 animate-fade-in-up">
                    <h1 className="text-4xl sm:text-5xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 drop-shadow-[0_0_15px_rgba(34,211,238,0.4)]">
                        Smart Attendance
                    </h1>
